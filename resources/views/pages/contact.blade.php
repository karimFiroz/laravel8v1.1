      ...
      <div class="container">
        ...
        <div class="row align-items-stretch retro-layout">
          ...
          <div class="col-md-5 order-md-2">
            <a href="{{asset('public/website')}}/single.html" class="hentry img-1 h-100 gradient" style="background-image: url('images/img_4.jpg');">
          ...
          <div class="col-md-7">
            ...
            <a href="{{asset('public/website')}}/single.html" class="hentry img-2 v-height mb30 gradient" style="background-image: url('images/img_1.jpg');">
            ...
            <div class="two-col d-block d-md-flex">
              <a href="{{asset('public/website')}}/single.html" class="hentry v-height img-2 gradient" style="background-image: url('images/img_2.jpg');">
              ...
              <a href="{{asset('public/website')}}/single.html" class="hentry v-height img-2 ml-auto gradient" style="{{asset('public/website')}}/background-image: url('images/img_3.jpg');">
